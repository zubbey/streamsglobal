...
<body class="body">
  ...
  <div class="container">
    ...
    <div id="alert" class="alert alert-warning alert-dismissable flyover flyover-centered comingsoonMsg" role="alert">
      <div class="justify-content-between d-flex">
        <h3>Coming soon!</h3>
        <span><i class="fas fa-exclamation-triangle"></i></span>
      </div>
...
//          ';
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-4 col-md-8 mb-5 mb-lg-0 mx-auto">
          ...
          if ($_SESSION['verified'] == 0 || strlen($_SESSION['referralcode']) <= 0) {
            echo '<a onclick="verifyaccountMsg()" class="after-loop-item card border-0 rounded-lg piggy-themes shadow-lg">';
          } else {
          ...
          <div class="card-body d-flex align-items-end flex-column text-right text-white">
            <h4>Piggy Wallet</h4>
            <p class="w-75">Automatically save an amount...</p>
      ...
      <div class="col-lg-4 col-md-8 mb-5 mb-lg-0 mx-auto">
        <?php
        if ($_SESSION['verified'] == 0 || strlen($_SESSION['referralcode']) <= 0) {
          echo '<a onclick="verifyaccountMsg()" class="after-loop-item card border-0 rounded-lg saap-themes shadow-lg">';
        } else {
    ...
    <div class="col-lg-4 col-md-8 mx-auto">
      <?php
      if ($_SESSION['verified'] == 0 || strlen($_SESSION['referralcode']) <= 0) {
        echo '<a onclick="verifyaccountMsg()" class="after-loop-item card border-0 rounded-lg fixed-themes shadow-lg">';
      } else {
...
<div class="col-lg-4 col-md-8 mb-5 mb-lg-0">
  <?php
  if ($_SESSION['verified'] == 0 || strlen($_SESSION['referralcode']) <= 0) {
    echo '<a onclick="verifyaccountMsg()" class="after-loop-item card border-0 rounded-lg cooperators-themes shadow-lg">';
  } else {
...
<div class="col-lg-4 col-md-8 mb-5 mb-lg-0">
  <?php
  if ($_SESSION['verified'] == 0 || strlen($_SESSION['referralcode']) <= 0) {
    echo '<a onclick="comingsoonMsg()" class="after-loop-item card border-0 rounded-lg comingsoon-themes shadow-lg">';
  } else {
    echo '<a href="#" class="after-loop-item card border-0 rounded-lg cooperators-themes shadow-lg">';
  }
  ?>
  <div class="card-body d-flex align-items-end flex-column text-right text-white">
    <h4>Land Savings</h4>
    <p class="w-75">Coming soon!</p>
