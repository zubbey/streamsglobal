...
try {
    ...
    sendVerificationEmail($userEmail, $token){
      ...
      body {
        ...
        <a http://localhost/~zubbey/streamsglobal/sign-up.php?success=step3&token=" . $token . "' style='padding: 10px; background: #19b334; color: ffffff; margin: 0; border: 0; box-shadow: 0; font-size: 1.2rem; font-family: sans-serif; cursor: pointer; display: inline-flex;'>Verify your email address</a>
        ...
        <a http://localhost/~zubbey/streamsglobal/sign-up.php?success=step3&token=" . $token . "' style='padding: 10px; background: #19b334; color: ffffff; margin: 0; border: 0; box-shadow: 0; font-size: 1rem; font-family: sans-serif; cursor: pointer; display: inline-flex;'>Verify your email address</a>
        </td>
        </tr>
