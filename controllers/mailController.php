							...
							<tbody>
								...
								<tr>
									<td style='font-size: 0;background: #ffffff;padding:0px 0px 32px 0px;' align='center'>
										...
										<a href='https://www.streamsglobal.com/start.php?token=" . $token . "' style='padding: 10px; background: #19b334; color: ffffff; margin: 0; border: 0; box-shadow: 0; font-size: 1.2rem; font-family: sans-serif; cursor: pointer; display: inline-flex;'>Verify your email address</a>
							...
							<tbody>
								...
								<tr>
									...
									<td style='font-size: 0;padding: 0px 0px 16px 0px;'>
										<a href='https://www.streamsglobal.com/start.php?token=" . $token . "' style='padding: 10px; background: #19b334; color: ffffff; margin: 0; border: 0; box-shadow: 0; font-size: 1rem; font-family: sans-serif; cursor: pointer; display: inline-flex;'>Verify your email address</a>
									</td>
								</tr>
...
$headers .= 'Reply-To: help@streamsglobal.com' . "\r\n";
